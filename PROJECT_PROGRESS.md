...
- **Dernier commit :** `fffb2d7` — feat(gallery): build premium gallery with category filters and accessible lightbox *(placeholder — à mettre à jour à chaque fin de Milestone)*
...
- Squelettes de base pour Vidéos et Contact (structure HTML minimale, non finalisés).

## Fonctionnalités restantes

- Galerie vidéos complète (lecteur, mise en page, filtres si nécessaire).
...
- Le Milestone 7 (Videos) sera le prochain chantier après validation de l'utilisateur.
